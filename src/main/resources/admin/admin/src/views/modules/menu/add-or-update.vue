	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 40px 30px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20230316/ceb93d14d79c4fe1835e7b1e4ec86ed2.jpg)","backgroundSize":"100% 100%","backgroundPosition":"left top","backgroundRepeat":"no-repeat","height":"auto"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="菜单" prop="menujson">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.menujson" label="菜单" prop="menujson">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.menujson}}</span>
				</el-form-item>
