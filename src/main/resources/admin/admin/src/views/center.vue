  ...
  <div :style='{"minHeight":"100vh","padding":"30px 40px 30px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20230316/ceb93d14d79c4fe1835e7b1e4ec86ed2.jpg)","backgroundSize":"100% 100%","backgroundPosition":"left top","backgroundRepeat":"no-repeat","height":"auto"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='huanzhe'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='huanzhe'"  label="年龄" prop="nianling">
