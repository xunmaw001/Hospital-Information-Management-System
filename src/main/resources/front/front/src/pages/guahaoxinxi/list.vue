    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.huanzhexingming != '') searchWhere.huanzhexingming = '%' + this.formSearch.huanzhexingming + '%';
	      params['sfsh'] = '是';
        this.$http.get('guahaoxinxi/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/guahaoxinxiDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
